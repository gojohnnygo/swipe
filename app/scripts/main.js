        ...
        stack.on('throwout', function (e) {
            ...
            switch (e.throwDirection) {
                case 'RIGHT':
                    ...
                    last = e.target.dataset.odk === 'd' ? "correct" : "incorrect";
                    break;
                case 'LEFT':
                    ...
                    last = e.target.dataset.odk === 'o' ? "correct" : "incorrect";
                    break;
                case 'DOWN':
                    ...
                    last = e.target.dataset.odk === 'k' ? "correct" : "incorrect";
                    break;
               case 'UP':
                    // var kickingCount = $('#kicking-count').html();
                    // kickingCount = parseInt(kickingCount) + 1;
                    ...
                    last = e.target.dataset.odk === 's' ? "correct" : "incorrect";
                    break;
                default:
