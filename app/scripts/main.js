    ...
    $( document ).ready(function() {
        ...
        $(".undo").bind("mouseup touchend", function(e) {
            ...
            if ((correct + incorrect) > 0) {
                ...
                count++
                var lastCard = lastCards.pop();
            var $lastCard = $(lastCard);
            $lastCard.remove();
            $lastCard.appendTo($("#full-game"));
            stack.getCard(lastCard).throwIn(0, 0);
            }
        ...
        stack.on('throwout', function (e) {
            ...
            switch (e.throwDirection) {
                case 'RIGHT':
                    ...
                    last.push(e.target.dataset.odk === 'd' ? "correct" : "incorrect");
                    break;
                case 'LEFT':
                    ...
                    last.push(e.target.dataset.odk === 'o' ? "correct" : "incorrect");
                    break;
                case 'DOWN':
                    ...
                    last.push(e.target.dataset.odk === 'k' ? "correct" : "incorrect");
                    break;
               case 'UP':
                    // var kickingCount = $('#kicking-count').html();
                    // kickingCount = parseInt(kickingCount) + 1;
                    ...
                    last.push(e.target.dataset.odk === 's' ? "correct" : "incorrect");
                    break;
                default:
